        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundDetail = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 43, "Financial Translation", 6 },
                    { 24, "App Design & Development", 3 },
                    { 44, "Technical Translations", 6 },
                    { 23, "App Strategy", 3 },
            ...
            migrationBuilder.InsertData(
                table: "SubServices",
                columns: new[] { "Id", "Name", "ServiceId" },
                values: new object[] { 20, "Website Maintenance", 3 });

            migrationBuilder.InsertData(
                table: "SubServices",
                columns: new[] { "Id", "Name", "ServiceId" },
                values: new object[] { 22, "Government Website Services", 3 });
